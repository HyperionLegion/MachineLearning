...
for i in range(len(x)):
    if z[i] == 0:
        ax.scatter((x[i]-xavg), (y[i]-yavg), color='red', marker="x", label="yes default")
    else:
        ax.scatter((x[i]-xavg), (y[i]-yavg), color='blue', facecolors='none', edgecolors='b', label="no default")
...
ax.axline((0, 0), slope=line1dy/line1dx, color='C0', label='by slope')
ax.axline((0, 0), slope=line2dy/line2dx, color='C0', label='by slope')
