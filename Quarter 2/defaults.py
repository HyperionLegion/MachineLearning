...
#to find b0, b1:
#Guess b0 not equal b1
#Calculate sum
#change b0 to b0 + delta
#recalculate sum
#determine if adding or subtracting was the correct or wrong direction
#repeat process for b1, (change b1 to b1 + delta)
